...
<div class="quick-links-bar" id="quick-links-bar">
    <div class="ql-inner">
        ...
        <div class="ql-right">
            <a href="https://www.facebook.com/share/18kgmoXwai/" class="ql-item ql-social" id="ql-fb" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://www.instagram.com/hortfarmafrica?igsh=MWV0ZjRkbzBhaTF5Zg==" class="ql-item ql-social" id="ql-ig" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z" fill="none" stroke="white" stroke-width="1.5"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" stroke="white" stroke-width="2" stroke-linecap="round"/></svg>
            </a>
            <a href="https://wa.me/254734865099" class="ql-item ql-social" id="ql-wa" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
